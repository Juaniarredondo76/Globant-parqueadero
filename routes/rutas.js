...
import{ControladorAdministrador} from '../controllers/ControladorAdmin.js'
...
rutas.get('/api/v1/parqueadero/admins/', controladorAdministrador.buscarAdministrador)
...
rutas.get('/api/v1/parqueadero/celdas/', controladorCelda.buscarCelda)
